...
public class LineasTmpAdapter  extends BaseAdapter {
    private ArrayList<Lineas> listlineastmp;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Integer cantidadDevEntera = cantiDev.intValue();

        tv_codlineatmp.setText("Código:  " + lineas.getCodigo());
        tv_desclineatmp.setText(lineas.getNombre());
        tv_mtolineatmp.setText("Monto: " + mtoTotal.toString() + "$");
        tv_cantlineatmp.setText("Cantidad en Doc: " + cantidadEntera.toString());
        tv_pidtmp.setText(lineas.getPid());
        tv_cantdevol.setText("A devolver: " + cantidadDevEntera.toString());
