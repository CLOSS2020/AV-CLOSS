...
public class VendedoresAdapter extends BaseAdapter {
    ...
    private ArrayList<Estadistica> listestadistica;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        TextView tv_codvend = (TextView) convertView.findViewById(R.id.tv_codvend);
        TextView tv_nombrevend = (TextView) convertView.findViewById(R.id.tv_nombrevend);
        TextView tv_porcentaje = (TextView) convertView.findViewById(R.id.tv_porcentaje);
        TextView tv_fechaact   = (TextView) convertView.findViewById(R.id.tv_fechaact);
        ImageView im_estrella  = (ImageView) convertView.findViewById(R.id.im_estrella);
