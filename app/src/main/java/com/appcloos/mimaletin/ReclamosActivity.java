...
public class ReclamosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.moveToFirst()) {
            ...
            Objects.requireNonNull(getSupportActionBar()).setTitle("Devo.:" + nroDev);
        }
        cursor.close();
        ...
        listaLineas.setOnItemClickListener((adapterView, view, position, l) -> {
            ...
            final EditText cajacantidad = new EditText(new ContextThemeWrapper(ReclamosActivity.this,R.style.EditTextStyleCustom));
            cajacantidad.setInputType(InputType.TYPE_CLASS_NUMBER);

            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(ReclamosActivity.this,R.style.AlertDialogCustom));
            builder.setTitle("Mensaje del Sistema");
            builder.setMessage("Por favor, selecciona una opción: ");

            builder.setNegativeButton("Borrar articulo", (dialogInterface, i) -> {
            ...
            builder.setPositiveButton("Modificar Cantidad", (dialogInterface, i) -> {

                AlertDialog.Builder dialogocantidad = new AlertDialog.Builder(new ContextThemeWrapper(ReclamosActivity.this,R.style.AlertDialogCustom)); //aqui lo llamo igual
                dialogocantidad.setTitle("Introduce una cantidad");
                dialogocantidad.setView(cajacantidad);
                dialogocantidad.setPositiveButton("Aceptar", (dialogInterface1, i1) -> {
                    ...
                    if (cantidadNueva <= 0) {
                        ...
                        if (cantidadNueva > cantidad) {
                            ...
                            Double cantidadN = (double) cantidadNueva;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                ...
                case R.id.iclinearec:
                    AlertDialog.Builder dialogolineas = new AlertDialog.Builder(new ContextThemeWrapper(ReclamosActivity.this,R.style.AlertDialogCustom));
                    //dialogolineas.setTitle("Elige el o los articulos a devolver");

                    TextView title = new TextView(ReclamosActivity.this);
                    ...
                    title.setText("Elige el o los articulos a devolver");
                    ...
                    lineasdoc.setOnItemClickListener((adapterView, view, position, l) -> {
                        ...
                        final EditText cajatexto = new EditText(new ContextThemeWrapper(ReclamosActivity.this,R.style.EditTextStyleCustom));
                        cajatexto.setInputType(InputType.TYPE_CLASS_NUMBER);

                        AlertDialog.Builder dialogocantidad = new AlertDialog.Builder(new ContextThemeWrapper(ReclamosActivity.this,R.style.AlertDialogCustom));

                        dialogocantidad.setTitle("Selecciona la cantidad a devolver");
                        dialogocantidad.setView(cajatexto);
                        dialogocantidad.setPositiveButton("Aceptar", (dialogInterface, i) -> {
                ...
                case R.id.icnota:
                    ...
                    final EditText textomotivo = new EditText(new ContextThemeWrapper(ReclamosActivity.this,R.style.EditTextStyleCustom));
                    ...
                    AlertDialog.Builder builderNota = new AlertDialog.Builder(new ContextThemeWrapper(ReclamosActivity.this,R.style.AlertDialogCustom));
                    ...
                    builderNota.setPositiveButton("Guardar", (dialogInterface, i) -> {
                ...
                case R.id.icclasif:
                    ...
                    codigosClasif = listaCodigos.toArray(new String[0]);
                    motivosClasif = listaMotivos.toArray(new String[0]);

                    AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(ReclamosActivity.this,R.style.AlertDialogCustom));
                    builder.setTitle("Elige el motivo del reclamo");
                    builder.setSingleChoiceItems(motivosClasif, posicionClasif, (dialog, which) -> {
        ...
        if (cursor.getCount() > 0) {
            ...
            if ((codSeleccionado == null) || (codSeleccionado.trim().equals("0")) || (codSeleccionado.trim().equals(""))) {
                ...
                if (listaImagenes.size() == 0) {
                    ...
                    if (ll_commit) { //si las acciones se ejecutaron bien, hago commit
                        ke_android.setTransactionSuccessful();
                        ke_android.endTransaction();
    ...
    private void cargarReclamos() {
        ...
        JSONArray arrayMV = new JSONArray();
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if (codigoExiste > 0) {
                            ...
                            System.out.println("ACTUALIZO EL: " + codigo);
                        } else if (codigoExiste == 0) {
                            ke_android.insert("ke_doclmv", null, qDocumentosLin);
                            System.out.println("INSERTO EL: " + codigo);
                        }
                        ll_commit = true;
