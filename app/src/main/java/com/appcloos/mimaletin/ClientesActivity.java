...
public class ClientesActivity extends AppCompatActivity implements  ClienteAdapter.ViewHolderDatos.onClienteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaClientes = (RecyclerView) findViewById(R.id.lv_clientes);
  ...
  /*  public void Onclick(View view){
    ...
    public void BuscarClientes(String busqueda){
       ...
       // String busqueda = buscador.getText().toString().trim();
        ...
        if(busqueda.equals("")){
            ...
            Cursor cursor = ke_android.rawQuery("SELECT codigo, nombre, direccion FROM cliempre WHERE vendedor ='"+ cod_usuario.toString().trim() +"' AND (nombre LIKE '%" + busqueda + "%' OR codigo LIKE'%" + busqueda + "%')", null);
    ...
    private void consultarClientes() {
        ...
        //select codigo, nombre from articulo
        Cursor cursor = ke_android.rawQuery("SELECT codigo, nombre, direccion FROM cliempre WHERE vendedor ='" + cod_usuario.toString().trim() + "'  ORDER BY nombre ASC", null);
    ...
    public void onItemClick(int position) {
        ...
        AlertDialog.Builder ventana = new AlertDialog.Builder(ClientesActivity.this);
        ventana.setTitle(nombreCliente);
        ventana.setMessage("Por favor, seleccione una opción");
        ventana.setPositiveButton("Ver documentos", new DialogInterface.OnClickListener() {
            @Override
