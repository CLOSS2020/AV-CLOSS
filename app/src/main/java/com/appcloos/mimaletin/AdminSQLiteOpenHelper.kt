...
(val context: Context?, val name: String?, val factory: CursorFactory?) :
  ...
  ('ke_doccti',   '0001-01-01 01:01:01')"""
        ...
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS listvend(codigo TEXT, nombre TEXT, telefonos Text, telefono_movil TEXT, status REAL, superves REAL, supervpor TEXT, sector TEXT, subcodigo TEXT, nivgcial REAL, fechamodifi NUMERIC)"
        )
        keAndroid.execSQL("CREATE TABLE IF NOT EXISTS sectores(codigo TEXT PRIMARY KEY,zona TEXT, fechamodifi NUMERIC)")
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS config2(id_precio1 TEXT ,id_precio2 TEXT, id_precio3 TEXT, id_precio4 TEXT, id_precio5 TEXT, id_precio6 TEXT, id_precio7 TEXT)"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS subsectores(codigo TEXT, subcodigo TEXT , subsector TEXT, fechamodifi NUMERIC)"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS subgrupos(codigo TEXT , subcodigo TEXT  , nombre TEXT , fechamodifi NUMERIC)"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS grupos(codigo TEXT PRIMARY KEY, nombre TEXT, fechamodifi NUMERIC)"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS usuarios(nombre TEXT, username TEXT, password TEXT, vendedor TEXT, almacen TEXT, desactivo REAL, fechamodifi NUMERIC, ualterprec REAL, sesionactiva NUMERIC, superves TEXT, ult_sinc NUMERIC DEFAULT '0001-01-01', sinc_primera NUMERIC NOT NULL DEFAULT 0/*,empresa TEXT NOT NULL DEFAULT '', PRIMARY KEY(empresa)*/);"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_opti(kti_ndoc TEXT, kti_tdoc TEXT, kti_codcli TEXT, kti_nombrecli TEXT, kti_codven TEXT, kti_docsol TEXT, kti_condicion TEXT, kti_tipprec REAL, kti_totneto REAL, kti_status TEXT, kti_nroped TEXT, kti_fchdoc NUMERIC, fechamodifi NUMERIC, kti_negesp TEXT, kti_totnetodcto REAL NOT NULL DEFAULT 0, ke_pedstatus TEXT NOT NULL DEFAULT '00')"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_opmv(kti_tdoc TEXT, kti_ndoc TEXT, kti_tipprec REAL, kmv_codart TEXT, kmv_nombre TEXT, kmv_cant REAL, kmv_artprec REAL, kmv_stot REAL, kmv_dctolin REAL NOT NULL DEFAULT 0, kmv_stotdcto REAL NOT NULL DEFAULT 0)"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_carrito(kmv_codart TEXT, kmv_nombre TEXT, kmv_cant REAL,  kmv_artprec REAL, kmv_stot REAL, kmv_dctolin REAL NOT NULL DEFAULT 0, kmv_stotdcto REAL NOT NULL DEFAULT 0)"
        )
        keAndroid.execSQL("CREATE TABLE IF NOT EXISTS ke_correla(kco_numero INTEGER, kco_vendedor TEXT)")
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_kardex(kde_codart TEXT PRIMARY KEY, kde_cantidad REAL, ke_fecha NUMERIC)"
        )
        keAndroid.execSQL(
        ...
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_cxc(kcx_nrorecibo VARCHAR (17), kcx_codcli VARCHAR(20), kcx_codven TEXT, kcx_ncliente VARCHAR(100), kcx_monto NUMERIC, kcx_fechamodifi NUMERIC, kcx_status TEXT)"
        )
        keAndroid.execSQL("CREATE TABLE IF NOT EXISTS ke_correlacxc(kcc_numero INTEGER, kcc_vendedor TEXT)")
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_limitart(kli_track TEXT, kli_codven TEXT, kli_codcli TEXT, kli_codart TEXT, kli_cant INTEGER, kli_fechahizo NUMERIC, kli_fechavence NUMERIC, status TEXT)"
        )
        ...
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_tiporecl(kdv_codclasif CHAR, kdv_nomclaweb TEXT, kdv_nomclasif TEXT, kdv_hlpclasif LONGTEXT, fechamodifi NUMERIC)"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_enlace(kee_codigo TEXT, kee_nombre TEXT, kee_url TEXT, kee_status TEXT, kee_sucursal TEXT)"
        )
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_modulos(ked_codigo TEXT, kmo_codigo TEXT, kmo_status TEXT, kee_sucursal TEXT)"
        )
...
// TABLA DE LINEAS DE CXC
  ...
  fechamodifi datetime NOT NULL DEFAULT '1000-01-01 00:00:00')"""
        ...
        keAndroid.execSQL(
            "CREATE TABLE IF NOT EXISTS ke_mtopendcli(" + " codcliente TEXT NOT NULL DEFAULT '', " + " id_recibo TEXT NOT NULL DEFAULT '', " + " moneda TEXT NOT NULL DEFAULT '1', " + " montocli REAL NOT NULL DEFAULT '0.0000000', " + " estado TEXT NOT NULL DEFAULT '0', " + " id_reciboap TEXT NOT NULL DEFAULT '', " + " agencia TEXT NOT NULL DEFAULT '', " + " tipodoc TEXT NOT NULL DEFAULT '', " + " documento TEXT NOT NULL DEFAULT '', " + " fchregdif TEXT NOT NULL DEFAULT '0000-00-00 00:00:00', " + " usuario TEXT NOT NULL DEFAULT '', " + " edoweb TEXT NOT NULL DEFAULT '0', " + " fechamodifi TEXT NOT NULL DEFAULT '0000-00-00 00:00:00' " + ")"
        )
        keAndroid.execSQL(
  ...
  `fechamodifi` datetime NOT NULL DEFAULT '1000-01-01 00:00:00'
        ...
        try {
            ...
            keAndroid.execSQL(
                "CREATE TABLE IF NOT EXISTS usuarios(" + "nombre TEXT DEFAULT ''," + "username TEXT DEFAULT ''," + "password TEXT DEFAULT ''," + "vendedor TEXT DEFAULT ''," + "almacen TEXT DEFAULT ''," + "desactivo REAL DEFAULT ''," + "fechamodifi NUMERIC DEFAULT ''," + "ualterprec REAL DEFAULT ''," + "sesionactiva NUMERIC DEFAULT 0," + "superves TEXT DEFAULT ''," + "ult_sinc NUMERIC DEFAULT '0001-01-01'," + "sinc_primera NUMERIC NOT NULL DEFAULT 0," + "empresa TEXT NOT NULL DEFAULT '081196'," + "PRIMARY KEY(empresa));"
            )
            keAndroid.execSQL(
        ...
        try {
            ...
            keAndroid.execSQL(
                "CREATE TABLE IF NOT EXISTS tabla_aux(" + "tabla TEXT NOT NULL DEFAULT ''," + "fchhn_ultmod TEXT NOT NULL DEFAULT ''," + "empresa TEXT NOT NULL DEFAULT '${Constantes.CLO}'," + "PRIMARY KEY(tabla, empresa));"
            )
            keAndroid.execSQL(
        ...
        try {
            ...
            keAndroid.execSQL(
                "CREATE TABLE IF NOT EXISTS grupos(" + "codigo TEXT NOT NULL DEFAULT ''," + "nombre TEXT NOT NULL DEFAULT ''," + "fechamodifi TEXT NOT NULL DEFAULT ''," + "empresa TEXT NOT NULL DEFAULT '${Constantes.CLO}'," + "PRIMARY KEY(codigo, empresa));"
            )
            keAndroid.execSQL(
        ...
        try {
            ...
            keAndroid.execSQL(
                "CREATE TABLE IF NOT EXISTS sectores(" + "codigo TEXT NOT NULL DEFAULT ''," + "zona TEXT NOT NULL DEFAULT ''," + "fechamodifi TEXT NOT NULL DEFAULT ''," + "empresa TEXT NOT NULL DEFAULT '${Constantes.CLO}'," + "PRIMARY KEY(codigo, empresa));"
            )
            keAndroid.execSQL(
        ...
        try {
            ...
            keAndroid.execSQL(
                "CREATE TABLE IF NOT EXISTS ke_kardex(" + "kde_codart TEXT NOT NULL DEFAULT ''," + "kde_cantidad TEXT NOT NULL DEFAULT ''," + "ke_fecha TEXT NOT NULL DEFAULT ''," + "empresa TEXT NOT NULL DEFAULT '${Constantes.CLO}'," + "PRIMARY KEY(kde_codart, empresa));"
            )
            keAndroid.execSQL(
        ...
        try {
            keAndroid.beginTransaction()
            keAndroid.execSQL("ALTER TABLE cliempre ADD dolarflete int NOT NULL DEFAULT '0';")
            keAndroid.execSQL("ALTER TABLE ke_doccti ADD dolarflete int NOT NULL DEFAULT '0';")
            keAndroid.execSQL("ALTER TABLE ke_opti ADD dolarflete int NOT NULL DEFAULT '0';")
            keAndroid.execSQL("ALTER TABLE ke_precobradocs ADD dolarflete int NOT NULL DEFAULT '0';")
            keAndroid.setTransactionSuccessful()
        } catch (e: SQLException) {
            Toast.makeText(context, "BDD: Evento oC 1", Toast.LENGTH_SHORT).show()
            e.printStackTrace()
        } finally {
            keAndroid.endTransaction()
        }
        ...
        try {
            keAndroid.beginTransaction()
            keAndroid.execSQL("ALTER TABLE ke_tabdctos ADD dcob_fechadoc DATE NOT NULL DEFAULT '0000-00-00';")
            keAndroid.setTransactionSuccessful()
        } catch (e: SQLException) {
            e.printStackTrace()
        } finally {
  ...
  `fechamodifi` datetime NOT NULL DEFAULT '1000-01-01 00:00:00'
        ...
        if (oldVersion < 56) {
            try {
                ...
                e.printStackTrace()
                Toast.makeText(context, "BDD: Evento oU 56", Toast.LENGTH_LONG).show()
            } finally {
                keAndroid.endTransaction()
            }
        }
        ...
        if (oldVersion < 57) {
            try {
                ...
                e.printStackTrace()
                Toast.makeText(context, "BDD: Evento oU 57", Toast.LENGTH_LONG).show()
            } finally {
                keAndroid.endTransaction()
            }
        }
...
// la nueva oldversion <= 34, pero arriba pon 35
    ...
    fun getConfigBool(config: String, codEmpresa: String): Boolean {
        ...
        var flag = false
        val cursor = db.rawQuery(
            "SELECT ${getConfigTipo("0")} FROM ke_wcnf_conf " + "WHERE cnfg_idconfig = '$config' AND empresa = '$codEmpresa';",
            null
        )
    ...
    fun getConfigString(config: String, codEmpresa: String): String {
        ...
        val texto: String
        val cursor = db.rawQuery(
            "SELECT ${getConfigTipo("C")} FROM ke_wcnf_conf " + "WHERE cnfg_idconfig = '$config' AND cnfg_activa = '1.0' AND empresa = '$codEmpresa';",
            null
        )
    ...
    fun getCampoBooleanCamposVarios(
        tabla: String,
        campo: String,
        campoWhere: List<String>,
        respuestaWhere: List<String>
    ...
    fun validarExistenciaGeneral(tabla: String): Boolean {
        var retorno = false
        val db = this.writableDatabase
        db.rawQuery("SELECT count(*) FROM $tabla;", null).use { cursor ->
            if (cursor.moveToFirst()) {
                retorno = cursor.getInt(0) > 0
            }
        }
    ...
    fun validarExistenciaCamposVarios(
        tabla: String,
        campo: ArrayList<String>,
        campoWhere: ArrayList<String>
    ): Boolean {
        var retorno = false
        val db = this.writableDatabase
    ...
    fun updateTablaAux(table: String, codEmpresa: String) {
        ...
        try {
            ...
            if (this.validarExistenciaCamposVarios(
                ...
                db.execSQL(
                    "INSERT INTO tabla_aux VALUES ('$table', '${fechaHoy(true)}', '$codEmpresa')"
                ) // <-- Colocandolo asi funciona, con las demas formas no
    ...
    fun articulosPromo(codEmpresa: String): ArrayList<Catalogo> {
        ...
        val db = this.writableDatabase
        db.rawQuery(
            "SELECT * FROM articulo WHERE dctotope > 0 AND (existencia - comprometido) > 0 AND empresa = '$codEmpresa';",
            null
        ).use { cursor ->
            while (cursor.moveToNext()) {
                try {
    ...
    fun getEdoGenCuenta(
        ...
        val db = this.writableDatabase
        var sql =
            "SELECT DISTINCT codcliente, nombrecli, SUM(dtotalfinal - (dtotpagos + dtotdev)) as montototal, MIN(vence) FROM ke_doccti WHERE estatusdoc < '2' AND vendedor = '$codUsuario' AND empresa = '$codEmpresa'"
        if (!text.isNullOrEmpty()) {
        ...
        db.rawQuery(
            ...
            if (cursor.moveToFirst()) {
                try {
                    ...
                    retorno.ktiNombrecli = cursor.getString(3)
                    retorno.ktiCodven = cursor.getString(4)
                    retorno.ktiDocsol = cursor.getString(5)
                    retorno.ktiCondicion = cursor.getString(6)
                    retorno.ktiTipprec = cursor.getDouble(7)
                    retorno.ktiTotneto = cursor.getDouble(8)
                    retorno.ktiStatus = cursor.getString(9)
                    retorno.ktiNroped = cursor.getString(10) ?: "No identificado"
                    retorno.ktiFchdoc = cursor.getString(11)
                    retorno.fechamodifi = cursor.getString(12)
                    retorno.ktiNegesp = cursor.getString(13)
        ...
        db.rawQuery(
            ...
            while (cursor.moveToNext()) {
                try {
                    ...
                    item.ktiTipprec = cursor.getDouble(2)
                    item.kmvCodart = cursor.getString(3)
                    item.kmvNombre = cursor.getString(4)
                    item.kmvCant = cursor.getDouble(5)
                    item.kmvArtprec = cursor.getDouble(6)
                    item.kmvStot = cursor.getDouble(7)
                    item.kmvDctolin = cursor.getDouble(8)
        ...
        db.rawQuery(sql, null).use { cursor ->
            while (cursor.moveToNext()) {
                try {
                    ...
                    item.email = cursor.getString(28)
                    item.empresa = cursor.getString(29)
                    item.dolarFlete = cursor.getInt(30)

                    retorno.add(item)
                } catch (e: Exception) {
                    e.printStackTrace()
                    Toast.makeText(context, "BDD: Evento gC 1", Toast.LENGTH_LONG).show()
                }
            }
        }
        cerarDB(db)
