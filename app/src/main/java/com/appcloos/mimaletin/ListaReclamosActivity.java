...
public class ListaReclamosActivity extends AppCompatActivity implements ReclamosAdapter.ViewHolderDatos.onReclamoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaReclamos = (RecyclerView)  findViewById(R.id.lv_reclamoslist);
    ...
    private void consultarReclamos() {
        ...
        listareclamo = new ArrayList<Reclamo>();
    ...
    private void ActualizarReclamos(String URL) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URL, new Response.Listener<JSONArray>() {
            ...
            @Override
            public void onResponse(JSONArray response) { //a traves de un json array request, traemos la informacion que viene del webservice
                ...
                if(response != null){ // si la respuesta no viene vacia
                    ...
                    JSONObject jsonObjecthead = null; //creamos un objeto json vacio para la cabecera
                    JSONObject jsonObjectlineas = null; //creamos un objeto json vacio para las lineas
                    ll_commit = false;
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ListaReclamosActivity.this, "Sin Actualización", LENGTH_LONG).show();
            }
        }){
            @Override
    ...
    public void onItemClick(int position){
        ...
        AlertDialog.Builder ventana = new AlertDialog.Builder(ListaReclamosActivity.this);
        ventana.setTitle("Opciones");
        ventana.setMessage("Por favor, selecciona una opción");

        ventana.setPositiveButton("Ver más información", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {

                AlertDialog.Builder dialogolineas = new AlertDialog.Builder(ListaReclamosActivity.this);
        ...
        ventana.setNeutralButton("Borrar Reclamo", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void cargarLineasRCL(String codReclamo) {
        ...
        listalineasrcl = new ArrayList<Reclamo>();
